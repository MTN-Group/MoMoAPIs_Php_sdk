...
class Oauth2TokenTest extends ProcessTestCase
{
    protected function setUp(): void
    {
        $this->constructorArgs = ['ABCD123', 'EFGH456', 'REMITTANCE', 'adfdfds342qwerty', 'qwe123'];
        $this->requestMethod = 'POST';
        $this->requestUrl = MobileMoney::getBaseUrl() .API::REMITTANCE_OAUTH2ACCESS_TOKEN;
