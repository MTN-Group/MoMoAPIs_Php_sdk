...
class Oauth2TokenDisbursementTest extends ProcessTestCase
{
    protected function setUp(): void
    {
        $this->constructorArgs = ['ABCD123', 'EFGH456', 'DISBURSEMENT', 'adfdfds342qwerty', 'qwe123'];
        $this->requestMethod = 'POST';
        $this->requestUrl = MobileMoney::getBaseUrl() .API::DISBURSEMENT_OAUTH2ACCESS_TOKEN;
