...
class AccessTokenDisbursementTest extends ProcessTestCase
{
    protected function setUp(): void
    {
        $this->constructorArgs = ['ABCD123', 'EFGH456', 'DISBURSEMENT', 'adfdfds342qwerty'];
        $this->requestMethod = 'POST';
        $this->requestUrl = MobileMoney::getBaseUrl() .API::DISBURSEMENT_ACCESS_TOKEN;
